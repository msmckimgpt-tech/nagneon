...
import {api} from './api';
type Report={limit:number;summary:{attempts:number;retained:number;modelSilent:number;generated:number;delivered:number;pending:number;rejected:Record<string,number>;outcomes:Record<string,number>;modelP50Ms:number|null;modelP95Ms:number|null}};
