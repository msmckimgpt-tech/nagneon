...
export const ClipsData=z.array(obj({id:z.string().uuid(),title:text,game:text,day:text,participants:z.array(obj({id,name:text})),sessionId:id,createdAt:time,updatedAt:time,scene:text,source:text,comments:z.array(comment),messages:z.array(message),video:z.boolean(),audio:z.boolean().optional().default(false),audioEligible:z.boolean().optional().default(false),audioStartedAt:time.optional(),audioEndedAt:time.optional(),thumbnail:z.enum(['png','jpg']).nullable()})).superRefine((clips,ctx)=>{
