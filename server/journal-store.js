...
const same=(a,b)=>a.id===b.id&&a.sessionId===b.sessionId&&a.at===b.at&&a.personaId===b.personaId&&a.name===b.name&&a.text===b.text&&a.fictional===b.fictional&&a.title===b.title&&a.pinned===b.pinned&&a.witnesses.join(',')===b.witnesses.join(',');
