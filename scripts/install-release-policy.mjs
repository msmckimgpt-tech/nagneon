...
const begin='<!-- BEGIN SERVICE-RELEASE-POLICY -->',end='<!-- END SERVICE-RELEASE-POLICY -->';
const source=await readFile(new URL('../docs/SERVICE-RELEASE-POLICY.md',import.meta.url),'utf8');
...
const folder=resolve('artifacts','release-policy-'+randomUUID());await mkdir(folder,{recursive:true});
