...
sourceFiles.push('server/world.js','server/audience-autonomy.js','server/audience.js','server/ambient.js','server/schema.js','server/clips.js','server/special-features.js','server/economy.js');
