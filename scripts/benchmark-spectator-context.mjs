...
const cases=[{id:'chat',args:{settings,history:[],speech:'오늘은 편하게 얘기하자. 모모는 어떤 게임 방송을 제일 좋아해?'}},{id:'decision',args:{settings,history:[],speech:'좋아. 미지의 신호부터 가보자. 항로는 정했으니 다시 물어보지 말고 출발하면서 한마디씩 해줘.'}},{id:'vision',args:{settings:{...settings,category:'gaming'},history:[],speech:'지금 화면에 어떤 일이 일어났어?',image:'data:image/jpeg;base64,'+readFileSync('artifacts/vision-fixture.jpg').toString('base64')}}];
const results=[];
