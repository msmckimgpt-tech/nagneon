...
0.1.4 기본 앱은 다운로드 약 **315MB**, 설치 약 **844MB**입니다. 마이크·시스템 소리·클립·GPU 기능을 처음 사용할 때 필요한 구성과 다운로드 크기를 보여주고 설치합니다. 설치된 구성은 이후 실행과 앱 업데이트에서 재사용하며, 설치가 끝난 압축 원본은 정리합니다. 모든 기능을 설치하면 추가 공간이 필요합니다. [용량과 실제 검증 범위](docs/DISTRIBUTION-SIZE.md)를 확인하세요.
