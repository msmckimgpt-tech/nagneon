...
위 선택창의 여백/잘림은 후속 패키지 `release/2026-09-13T01-45-11-001Z`에서 수정·검증했다. 이름을 먼저 표시하고 썸네일은 따로 채우므로 일부 WGC 창의 지연 중에도 대상을 선택하거나 닫을 수 있다. 실제 loopback과 혼합 녹화도 재검증했다. 최신 상세/한계는 `docs/CAPTURE-PICKER.md`를 따른다.
