...
아래 표와 관객 후보/유입 편집 설명은 초기 단계의 역사적 기록이다. 현재 제품은 [관객 자율성](AUDIENCE-AUTONOMY.md)과 [실제 게임 연결 수용](LIVE-CAPTURE-ACCEPTANCE.md)을 기준으로 하며, 사전 관객 구성·수동 클립·별도 기획 시작은 제공하지 않는다. 최신 전체 검사는 후자 문서의 242개 검사와 증거 경로를 참조한다.
